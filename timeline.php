...
<html>
	...
	<head>
		<title>Welcome  To Quix - Sign up, Log in, Post </title>
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Quix"><b>Quix</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div>
			<form method="post" enctype="multipart/form-data">
				<textarea placeholder="Write something here..." name="content" class="post-text" required></textarea>
